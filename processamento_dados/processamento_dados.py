...
class TerramProcessamento:
    ...
    def exportar_poligono_e_pontos(self):
        ...
        # Exemplo de uso:
        output_folder = 'C:/geoprocessamento/PROCESSAMENTO/'+ usuario +'/FileQgis/'
        ...
        def SelecionarCampos(campos_desejados, shapefile_saida):
            try:
                ...
                gdf = gpd.read_file('C:/geoprocessamento/PROCESSAMENTO/'+ usuario +'/poligono/co.shp')
        ...
        def recortar_e_carregar_camadas():
            ...
            for p in lista_perfil:
                recortar = processing.run('native:clip', {
                    'INPUT': p,
                    'OVERLAY': 'C:/geoprocessamento/PROCESSAMENTO/'+ usuario +'/poligono/co.shp',
                    'OUTPUT': os.path.join('C:/geoprocessamento/PROCESSAMENTO/'+ usuario +'/point', f'{p.name()}_parcial.shp')
                })
        ...
        # def BufferShapefile():
            ...
            # gdf = gpd.read_file('C:/geoprocessamento/PROCESSAMENTO/'+ usuario +'/poligono/co_temp.shp')

            # # Converte a distância de metros para graus (WGS84)
            # buffer_distance_degrees = 10 / 111320  # Aproximadamente 111320 metros por grau
            ...
            # gdf.to_file('C:/geoprocessamento/PROCESSAMENTO/'+ usuario +'/poligono/co_buffer.shp')
        
        

        # def dissolve_polygons(input_shp, separate_disjoint=False, output_filename='co_dissolvido.shp'):
            # """
            # Função para dissolver polígonos.

            # Parâmetros:
            # - input_shp: Caminho para o shapefile de entrada.
            # - separate_disjoint: Booleano para determinar se polígonos disjuntos devem ser separados (padrão False).
            # - output_filename: Nome do arquivo de saída (padrão para 'co_dissolvido.shp').

            # Retorna:
            # - Resultado do processamento, geralmente o caminho para o arquivo de saída.
            # """
            # output_path = f'C:/geoprocessamento/PROCESSAMENTO/'+ usuario +'/poligono/{output_filename}'
            # params = {
                # 'INPUT': input_shp,
                # 'FIELD': [],  # Vazio significa que todos os polígonos serão dissolvidos em um único polígono
                # 'SEPARATE_DISJOINT': separate_disjoint,
                # 'OUTPUT': output_path
            # }

            # result = processing.run("native:dissolve", params)
            # return result['OUTPUT']  # Retorna o caminho do arquivo de saída





        exportar_features_selecionadas(caminho_saida = 'C:/geoprocessamento/PROCESSAMENTO/'+ usuario +'/poligono/co.shp')
        SelecionarCampos(['CLIENTE', 'FAZENDA', 'TALHAO', 'BLOCO','GRID'], 'C:/geoprocessamento/PROCESSAMENTO/'+ usuario +'/poligono/co.shp') 
        #SelecionarCampos(['CLIENTE', 'FAZENDA'], 'C:/geoprocessamento/PROCESSAMENTO/poligono/co_temp.shp')        
        recortar_e_carregar_camadas()
        #BufferShapefile()
        #dissolve_polygons('C:/geoprocessamento/PROCESSAMENTO/poligono/co_buffer.shp')
    ...
    def PrepararCSVeDAT(self):
        ...
        def Add_Coordenadas_OrganizarDataFrame_Dentro_Da_Pasta():
            folder_path = 'C:/geoprocessamento/PROCESSAMENTO/'+ usuario +'/point/' 
        ...
        def Remove_Columns_Change_Value_Equal(gdf, columns_to_remove=None):
            ...
            for coluna in gdf.columns:
                if gdf[coluna].nunique() == 1:
                    ...
                    gdf.at[indice_aleatorio, coluna] += 0.01
        ...
        def Exportar_Csv_Em_Loop():
            for idx, cleaned_gdf in enumerate(cleaned_gdfs):
                Exportar_Csv_Todos_Atributos(cleaned_gdf, output_folder = 'C:/geoprocessamento/PROCESSAMENTO/'+ usuario +'/saida/' )
                
        def Remover_Csv_Que_Nao_Ira_Processar(keys_list):
            caminho_pasta = 'C:/geoprocessamento/PROCESSAMENTO/'+ usuario +'/saida/'
        ...
        def Renomear_Csv_Padrao_Terram():
            directory = 'C:/geoprocessamento/PROCESSAMENTO/'+ usuario +'/saida/'
            name_mapping = {
        ...
        def Csv_To_Dat():
            input_folder = 'C:/geoprocessamento/PROCESSAMENTO/'+ usuario +'/saida/'
            output_folder = 'C:/geoprocessamento/PROCESSAMENTO/'+ usuario +'/saida/'
    ...
    def PrepararParametrosBas(self):
        ...
        def UpdateBasWithBounds(bas_file_path, xmin, ymin, xmax, ymax, numCols, numRows):
            ...
            new_bas_file_path = 'C:/geoprocessamento/PROCESSAMENTO/'+ usuario +'/bas/krig.bas'
        ...
        bas_file_path = 'C:/geoprocessamento/PROCESSAMENTO/'+ usuario +'/bas/model.bas'
    ...
    def ExcutarSubProcessoSurfer8(self):
        ...
        vba_script_file = r'C:\geoprocessamento\PROCESSAMENTO\{usuario}\bas\krig.bas'.format(usuario=usuario)
    ...
    def PrepararShapefileRecApresentacao(self):
        ...
        def processar_grd(input_folder, output_folder, field_mapping):
            # Adicionar algoritmos nativos do QGIS
            QgsApplication.processingRegistry().addProvider(QgsNativeAlgorithms())

            # Loop através dos arquivos na pasta de entrada
            for filename in os.listdir(input_folder):
                if filename.endswith(".grd"):
                    input_raster = join(input_folder, filename)
                    output_file = join(output_folder, filename.replace(".grd", ".shp"))

                    # Obtenha o nome do campo com base no mapeamento
                    nome_sem_extensao = os.path.splitext(filename)[0]
                    field_name = field_mapping.get(nome_sem_extensao, "VALUE")
                    ...
                    processing.run("native:pixelstopolygons", parameters, feedback=feedback)

                    print(f"Processamento concluído para {filename}. Resultado salvo em {output_file}")
        ...
        processar_grd(input_folder, output_folder, field_mapping)
        ...
        RecortarShapefiles('C:/geoprocessamento/PROCESSAMENTO/'+ usuario +'/saida/', 'C:/geoprocessamento/PROCESSAMENTO/'+ usuario +'/poligono/co.shp', 'C:/geoprocessamento/PROCESSAMENTO/'+ usuario +'/apresentacao/', rec=False)
        #RecortarShapefiles('C:/geoprocessamento/PROCESSAMENTO/saida/', 'C:/geoprocessamento/PROCESSAMENTO/poligono/co_dissolvido.shp', 'C:/geoprocessamento/PROCESSAMENTO/rec/', rec=True)


        def copy_to_rec(source_folder, qgis_folder):
            ...
            for file_to_copy in files_to_copy:
                # Adicionando a condição para copiar apenas os arquivos desejados
                if any(file_to_copy.startswith(prefixo) for prefixo in [
                    'CTC1', 'CTC2', 'CTC3', 'CTC4', 'CTC5', 'CTC6', 'CTC6','CTC7',
                    'V1', 'V2', 'V3', 'V4', 'V5', 'V6', 'V5','V6','V7',
                    'Ca1', 'Ca2', 'Ca3', 'Ca4', 'Ca4', 'Ca5', 'Ca6','Ca7',
                    'Sat_Ca1', 'Sat_Ca2', 'Sat_Ca3',
        ...
        input_folder = 'C:/geoprocessamento/PROCESSAMENTO/'+ usuario +'/apresentacao/'
        output_folder = 'C:/geoprocessamento/PROCESSAMENTO/'+ usuario +'/rec/'
        copy_to_rec(source_folder = input_folder, qgis_folder = output_folder )
        ...
        pastas = ['C:/geoprocessamento/PROCESSAMENTO/'+ usuario +'/rec/', 'C:/geoprocessamento/PROCESSAMENTO/'+ usuario +'/apresentacao/']
        try:
        ...
        # Exemplo de uso:
        input_folder = 'C:/geoprocessamento/PROCESSAMENTO/'+ usuario +'/rec/'
        output_folder = 'C:/geoprocessamento/PROCESSAMENTO/'+ usuario +'/FileQgis/'
        ...
        def copy_to_qgis_folder(source_folder, qgis_folder):
            ...
            prefix = 'co_original'
            source_poligono_folder = 'C:/geoprocessamento/PROCESSAMENTO/'+ usuario +'/poligono/'
        ...
        # Exemplo de uso:
        source_folder = 'C:/geoprocessamento/PROCESSAMENTO/'+ usuario +'/apresentacao/'
        qgis_folder = 'C:/geoprocessamento/PROCESSAMENTO/'+ usuario +'/FileQgis/'
    ...
    def PuxarLayoutELegagendas(self):
        ...
        shapefile_folder = 'C:/geoprocessamento/PROCESSAMENTO/'+ usuario +'/FileQgis'
        style_folder = 'C:/geoprocessamento/PROCESSAMENTO/'+ usuario +'/legendas'
        ...
        shapefile_dir = 'C:/geoprocessamento/PROCESSAMENTO/'+ usuario +'/FileQgis'
    ...
    def LimparCacheArquivos(self):
        ...
        def limpar_pasta_geoprocessamento():
            caminho_base = 'C:/geoprocessamento/PROCESSAMENTO/'+ usuario 
    ...
    def OrganizarContornoPerfil(self):
        ...
        # def BufferShapefile():
            ...
            # # Converte a distância de metros para graus (WGS84)
            # buffer_distance_degrees = 15 / 111320  # Aproximadamente 111320 metros por grau
        ...
        # def dissolve_polygons(input_shp, separate_disjoint=False, output_filename='co_dissolvido.shp'):
            ...
            # - Resultado do processamento, geralmente o caminho para o arquivo de saída.
            # """
            # output_path = f'C:/geoprocessamento/PROCESSAMENTO/poligono/{output_filename}'
            # params = {
                # 'INPUT': input_shp,
                # 'FIELD': [],  # Vazio significa que todos os polígonos serão dissolvidos em um único polígono
                # 'SEPARATE_DISJOINT': separate_disjoint,
        ...
        exportar_features_selecionadas(caminho_saida = 'C:/geoprocessamento/PROCESSAMENTO/'+ usuario +'/poligono/co.shp')
        SelecionarCampos(['CLIENTE', 'FAZENDA', 'TALHAO', 'BLOCO','GRID', 'HECTARES'], 'C:/geoprocessamento/PROCESSAMENTO/'+ usuario +'/poligono/co.shp') 
        #SelecionarCampos(['CLIENTE', 'FAZENDA'], 'C:/geoprocessamento/PROCESSAMENTO/poligono/co_temp.shp')        
        recortar_e_carregar_camadas()
        #BufferShapefile()
        #dissolve_polygons('C:/geoprocessamento/PROCESSAMENTO/poligono/co_buffer.shp')
        ...
        def Remove_Columns_Change_Value_Equal(gdf, columns_to_remove=None):
            ...
            for coluna in gdf.columns:
                if gdf[coluna].nunique() == 1:
                    ...
                    # Choose a random index to add the value
                    indice_aleatorio = random.randint(0, len(gdf) - 1)
                    gdf.at[indice_aleatorio, coluna] += 0.00000001
    ...
    def ChamarLayoutIndividual(self):
        ...
        def load_shapefiles_and_apply_style(style_folder, field_mapping, shapefile_list):
            # Carrega o projeto QGIS
            project = QgsProject.instance()
        ...
        load_shapefiles_and_apply_style(style_folder, field_mapping, shapefile_list)
    ...
    def Replace(self):
        ...
        # Exemplo de uso
        pasta_geoprocessamento = 'C:/geoprocessamento/PROCESSAMENTO/'+ usuario +'/FileQgis'
    ...
    def run(self):
        ...
        ## Processamento individual disconect
        ...
        self.dlg.pushButtonProcessarIndividual.clicked.disconnect(self.ExcutarSubProcessoSurfer8)
        ...
        ##Processamento automatico disconect
